...
data_long_0 <- bind_rows(df1,df2) %>% 
  ...
  rowwise() %>% 
  mutate(OGAreaPortion = mean(c(OGAreaPortion_1950s, OGAreaPortion_1900s, OGAreaPortion_1920s,
                              OGAreaPortion_1930s, OGAreaPortion_1940s, OGAreaPortion_1960s,
                              OGAreaPortion_1970s, OGAreaPortion_1980s, OGAreaPortion_1990s,
                              OGAreaPortion_2000s, OGAreaPortion_pre1900, OGAreaPortion_1910s),
                              na.rm = T),
         OGAreaPortion2 = mean(c(OGAreaPortion_1980s, OGAreaPortion_1990s,OGAreaPortion_2000s),
                              na.rm = T)) %>% 
  ungroup()
...
for_summary[[1]] <- data_long %>% 
  select(#`Number of CCEs`=n_unique_FIPS,
         ...
         `Oil and Gas Production`=OGAreaPortion,
