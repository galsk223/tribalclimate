...
model.shell[[5]] <- ols_clustered(dep.var,df=data_long_m4_filledmissing,clust.var = c("tribe"))
model.shell[[6]] <- ols_clustered(dep.var,df=data_long_m4_fillednew,clust.var = c("tribe"))

sg_table(model.shell,
         dep.name = "Days per Year in excess of 100 degrees F",
         column.labels = c("OLS","\\shortstack{OLS \\\\ All Tribes}","\\shortstack{OLS \\\\ Excluding OTSA}","Poisson","\\shortstack{OLS | Filled \\\\ Disappeared Tribes}","\\shortstack{OLS | Filled \\\\ New Tribes}"),
         label = "tab:heat",
         title = "Extreme Heat")
...
sg_table(model.shell,
         dep.name = "Mean PDSI",
         column.labels = c("OLS","\\shortstack{OLS \\\\ All Tribes}","\\shortstack{OLS \\\\ Excluding OTSA}","Tribe FE","\\shortstack{OLS | Filled \\\\ Disappeared Tribes}","\\shortstack{OLS | Filled \\\\ New Tribes}"),
         label = "tab:drought",
         title = "Drought")
```
...
sg_table(model.shell,
         ...
         column.labels = c("OLS","\\shortstack{OLS \\\\ All Tribes}","\\shortstack{OLS \\\\ Excluding OTSA}","\\shortstack{OLS | Filled \\\\ Disappeared Tribes}","\\shortstack{OLS | Filled \\\\ New Tribes}"),
