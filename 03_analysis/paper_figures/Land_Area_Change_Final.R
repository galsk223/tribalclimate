...
# tribal lands data
dat_tribe <- read_csv("01_data/cache/tribe_bg_full_integrated_combined_FINAL.csv") %>%
...
# examine tribes which aren't included in our dataset - these are not currently included in the final calculations
